...
Dir.fillname     = '9MPa_mm';       % DONT include extension,in .mat or .dat format
...
Dir.unique       = 'Synthetic_Data_9MPa';   % uniqe name for data set, can be = Dir.fillname;
...
% Poisson's ratio,          Young's Modulus [Pa],      		Material Name     
  Dir.nu    = 0.3;          Dir.E  = 190E9;                 Dir.Mat = 'Ferrite';
