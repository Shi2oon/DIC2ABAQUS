function [BCf, UnitOffset] = DIC2CAE_wNAN(MatP, Crack, resultsDir)
...
MatP.input_unit = 'um'; DICdata.data=DICdata.data*1e3;
[alldata,dataDot] = reshapeData(DICdata.data);
...
if isempty(Crack)
    ...
    close all;      contourf(dataDot.X1,dataDot.Y1,Um,'LineStyle','none','HandleVisibility','off');
    ...
    saveas(gcf,[resultsDir '\' MatP.unique '_DIC2ABAQUS Coodrinate.tif'],'tiffn');  close
end
