function [J,K,KI,KII]=PlotKorJ(saveto,E,offset,input_unit,stepsize,pp)
...
set(0,'defaultAxesFontSize',22);       set(0,'DefaultLineMarkerSize',10)
%% input values
...
%{
        ...
        box off; 
        %}
        plotJKIII(KI,KII,J,stepsize,input_unit)
        saveas(gcf, [saveto '\' Ond '_Keff, KI and KII.fig']);
